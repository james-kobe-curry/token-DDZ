...
`0.1.8` 已实现不依赖电脑的 Android 手机房主 Beta。任意一台安装 APK 的 Android 手机都可在“好友房”中点击“本机创建房间”，另外两台同一局域网内的 Android 或 Apple 设备通过 APK 或浏览器加入。
...
- 结算后三名玩家可在原房间确认“再来一局”，无需重新填写地址和房间码。
