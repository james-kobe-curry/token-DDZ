...
export const AI_DIFFICULTIES = Object.freeze({
  super: Object.freeze({ id: 'super', name: '超强人机', shortName: '超强', memoryRatio: 1, planningHandLimit: 12, nodeLimit: 26000, samples: 72, teamwork: 1, structureWeight: 4.2, planningWeight: 28, controlWeight: 10, sampleWeight: 54, bombPenalty: 190, accuracy: 1, choiceWindow: 1, description: '采用 DouZero 预训练胜势网络，逐一评估全部合法动作，并结合记牌、角色位置、历史牌路和农民协作决策。' }),
